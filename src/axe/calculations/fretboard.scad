 ...
 * @param neck_thickness_mm   The thickness of the neck where it is being
 *                             sampled, in millimeters.
 * @param x_mm                The point to sample on the X axis, in millimeters.
 * @return                    The angle of the given point on the X axis around
 *                            the origin of the fretboard radius.
 */
function y_mm_over_fretboard_radius_origin(fretboard_radius_mm, radius_offset_mm, neck_thickness_mm, x_mm) = cos(degrees_around_fretboard_radius_origin(fretboard_radius_mm, x_mm)) * (fretboard_radius_mm + radius_offset_mm) + neck_thickness_mm - fretboard_radius_mm;
